...
source_directory = r'C:\Users\freed\Downloads\sleeping\images1'  # Change to your actual source directory

# Define the target directories
normal_folder = r'C:\Users\freed\Downloads\sleeping\dataset_path\Normal'  # Path to Normal folder
suspicious_folder = r'C:\Users\freed\Downloads\sleeping\dataset_path\Suspicious'  # Path to Suspicious folder
...
for file_name in os.listdir(source_directory):
    ...
    if os.path.isfile(file_path):
        ...
        if file_name.startswith('person_nn_'):
            ...
            if 0 <= number <= 1213:  # Move person_nn_0.jpg to person_nn_10.jpg to Normal folder
