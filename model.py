...
df = pd.read_csv(r'C:\Users\freed\Downloads\sleeping\dataset_path\dataset_pathdataset.csv')
...
model.save_model(r"C:\Users\freed\Downloads\sleeping\trained_model.json")
